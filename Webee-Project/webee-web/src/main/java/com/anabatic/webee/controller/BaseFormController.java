...
// * 
// */
//package com.anabatic.webee.controller;
//
...
//
//import com.anabatic.webee.Constants;
//
///**
...
//	    private CoreUserManager userManager = null;
...
//
//	    @Autowired
//	    public void setUserManager(@Qualifier("coreUserManager") CoreUserManager userManager) {
//	        this.userManager = userManager;
//	    }
//
//	    public CoreUserManager getUserManager() {
...
//	        return this.successView == null ? "redirect:/" : this.successView;
//	    }
//
...
//	    public String unAuthenticatedException(UnauthenticatedException ex, HttpServletRequest request) {
//	        log.debug(ex);
...
//	     public String authorizationException(AuthorizationException ex, HttpServletRequest request) {
//	        log.debug(ex);
//	        saveError( request, ex.getMessage());
//	        return "redirect:/403";
//	    }
...
//	    public String accessDeniedException(Exception ex, HttpServletRequest request) {
//	        log.debug(ex);
//	        saveError( request, ex.getMessage());
//	        return "redirect:/403";
//	    }
